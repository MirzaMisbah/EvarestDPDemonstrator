class ShoppingDealCmin extends tucana.minion.VisualizationCmin {
    ...
    async activate() {
        ...
        this.uiAdapter.showIframe(this.instanceId, "del_status.html");
        this.uiAdapter.requestInput(this.instanceId, "binary", "Delivery Status", this.setActive.bind(this));
        var _this = this;
        this.uiAdapter.requestInput(this.instanceId, "action", "Delivery Status", function () {
            _this.uiAdapter.addData(_this.instanceId, true);
            _this.uiAdapter.sendNotification(_this.instanceId, "Delivery Status");
        });
