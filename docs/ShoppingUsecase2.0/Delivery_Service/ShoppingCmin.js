class ShoppingDealCmin extends tucana.minion.Pmin {
    ...
    async activate() {
        ...
        this.count = 0;
        const _this = this;
        var b = document.getElementById('statb');        
        b.onclick = function(){
            _this.getstatdiv();
        }
        //document.getElementById('statb').addEventListener("click", _this.getstatdiv);
