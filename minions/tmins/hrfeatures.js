"use strict";
// Transcrypt'ed from Python, 2017-12-21 00:17:05
function hrfeatures () {
    ...
    */
	...
	(function () {
		...
		var convert_to_features = function (data) {
			var norm_mean = list ([142.2, 176.25, 183.0, 185.3, 185.25, 189.75, 190.45, 155.9, 133.45, 125.75, 119.5, 116.25, 13.75, 30.063, 1.6692, 0.65]);
			var norm_std = list ([25.67995327, 13.79447353, 12.4016128, 11.46778095, 13.0187365, 8.14785248, 8.38137817, 10.14839889, 12.17158576, 13.07239458, 11.83004649, 12.37285335, 1.44481833, 3.78217014, 0.07616797, 0.4769696]);
			var X = list ([]);
			var __iterable0__ = data;
			for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
				var patient = __iterable0__ [__index0__];
				var feature_vector = list ([]);
				var __iterable1__ = list (['hr_run', 'hr_cool']);
				for (var __index1__ = 0; __index1__ < len (__iterable1__); __index1__++) {
					var hr_data = __iterable1__ [__index1__];
					var py_values = patient [hr_data];
					var ids = list ([]);
					for (var p = 0; p < 5; p++) {
						var i = int ((p * len (py_values)) / 5.0);
						ids.append (i);
					}
					ids.append (len (py_values) - 1);
					var __iterable2__ = ids;
					for (var __index2__ = 0; __index2__ < len (__iterable2__); __index2__++) {
						var i = __iterable2__ [__index2__];
						var hrval = py_values [i];
						feature_vector.append (hrval [1]);
					}
				}
				var __iterable1__ = list (['age', 'bmi', 'height', 'therapy']);
				for (var __index1__ = 0; __index1__ < len (__iterable1__); __index1__++) {
					var feature_name = __iterable1__ [__index1__];
					feature_vector.append (patient [feature_name]);
				}
				var feature_vector = function () {
					var __accu0__ = [];
					var __iterable1__ = zip (feature_vector, norm_mean, norm_std);
					for (var __index1__ = 0; __index1__ < len (__iterable1__); __index1__++) {
						var __left0__ = __iterable1__ [__index1__];
						var v = __left0__ [0];
						var m = __left0__ [1];
						var s = __left0__ [2];
						__accu0__.append ((v - m) / s);
					}
					return __accu0__;
				} ();
		...
		var convert_to_targets = function (data) {
			return function () {
				var __accu0__ = [];
				var __iterable0__ = data;
				for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
					var v = __iterable0__ [__index0__];
					__accu0__.append (v ['target']);
				}
				return __accu0__;
			} ();
		};
		__pragma__ ('<all>')
			__all__.__name__ = __name__;
			__all__.convert_to_features = convert_to_features;
			__all__.convert_to_targets = convert_to_targets;
		__pragma__ ('</all>')
	}) ();
   return __all__;
}
window ['hrfeatures'] = hrfeatures ();
